...
YAMNET_BASE_THRESHOLD: float = env_float("YAMNET_BASE_THRESHOLD", "0.52")
YAMNET_VEHICLE_THRESHOLD: float = env_float("YAMNET_VEHICLE_THRESHOLD", "0.68")
YAMNET_NATURAL_THRESHOLD: float = env_float("YAMNET_NATURAL_THRESHOLD", "0.64")
YAMNET_MUSIC_THRESHOLD: float = env_float("YAMNET_MUSIC_THRESHOLD", "0.62")
YAMNET_SECONDARY_MIN_RATIO: float = env_float("YAMNET_SECONDARY_MIN_RATIO", "0.90")
YAMNET_TOP_K: int = env_int("YAMNET_TOP_K", "20")
YAMNET_MAX_LABELS: int = env_int("YAMNET_MAX_LABELS", "3")
...
_BUILTIN_YAMNET_PRESETS: dict[str, dict[str, float]] = {
    ...
    "noisy": {
        ...
        "music_threshold": 0.04,
        "secondary_min_ratio": 0.03,
    },
    "media": {
        "base_threshold": -0.12,
        "vehicle_threshold": -0.08,
        "natural_threshold": -0.08,
        "music_threshold": -0.14,
        "secondary_min_ratio": -0.12,
    },
}
